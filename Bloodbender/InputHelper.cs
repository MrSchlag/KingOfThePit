...
namespace KingOfThePit
{
    ...
    public class InputHelper
    {
        ...
        {
            _cursorSprite = new Sprite(KingOfThePit.ptr.Content.Load<Texture2D>("cursor"));
#if WINDOWS_PHONE
...
#endif
            _viewport = KingOfThePit.ptr.GraphicsDevice.Viewport;
        }
        ...
        public void Draw()
        {
            if (_cursorIsVisible && IsCursorValid)
            {
                ...
                //KingOfThePit.ptr.spriteBatch.Begin();
                KingOfThePit.ptr.spriteBatch.Draw(_cursorSprite.Texture, KingOfThePit.ptr.camera.ConvertScreenToWorld(new Vector2(mouse.X, mouse.Y)) , null, Color.White, 0f, _cursorSprite.Origin, 1f, SpriteEffects.None, 1.0f);
